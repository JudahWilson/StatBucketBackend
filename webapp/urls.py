...
router.register(r"PlayerGameOvertimeStats", api_views.PlayerGameOvertimeStatsViewSet)
...
router.register(r"TeamGameOvertimeStats", api_views.TeamGameOvertimeStatsViewSet)
...
urlpatterns = [
    ...
    # Api Auth
    path(
        f"api/v{settings.API_VERSION}/api-auth/",
        include("rest_framework.urls", namespace="rest_framework"),
    ),
    path(f"api/v{settings.API_VERSION}/", include(router.urls)),
    path(
        f"api/v{settings.API_VERSION}/generic/<str:stat_model>/",
        api_views.datatables_view,
    ),
    path(
        f"api/v{settings.API_VERSION}/generic/<str:stat_model>/columns/",
        api_views.datatables_schemas_view,
    ),
    ###############################
    # HTMX
    ###############################
